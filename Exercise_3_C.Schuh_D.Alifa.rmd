...
```{r}
vornamen_2021 <- read.csv("C:/Users/Const/Desktop/Bachelor Geographie/6. Semester/Fortgeschrittene Statistische Software/data/open_data_portal_2022.csv")
 ...
 * The Problem was that in "Anzahl" every Number under 5 was displayed as "4 oder weniger" which has characters. When you convert to numerical all rows with "4 oder weniger" turn into NA -> Missing values.
